...
const footerLinks = {
  ...
  categories: [
    { label: "Tailors", href: "/category/tailors", icon: Scissors },
    { label: "Home Cooked Food", href: "/category/food", icon: ChefHat },
    { label: "Handmade Products", href: "/category/handmade", icon: Palette },
    { label: "Home Services", href: "/category/home-services", icon: Home },
    { label: "Catering", href: "/category/catering", icon: Utensils },
  ],
};
...
const contactInfo = {
  address: "123 LocalCraft Street, Community City, CC 12345",
  phone: "+1 (555) 123-4567",
  email: "hello@localcraft.com",
        ...
        <div className="container mx-auto px-6 py-6">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <div className="flex items-center gap-2 text-sm text-gray-600 dark:text-gray-400">
              <span>© 2024 ArtisanHub. Made with</span>
